...
import enemyLegsIdleUrl from "../../assets/vendor/valentint-scifi/Legs/Enemy/enemy_legs_idle_Sheet.png?url";
import enemyLegsRunUrl from "../../assets/vendor/valentint-scifi/Legs/Enemy/enemy_legs_run_Sheet.png?url";
import enemyLegsWalkUrl from "../../assets/vendor/valentint-scifi/Legs/Enemy/enemy_legs_walk_sheet.png?url";
...
const spriteSheets: SpriteSheetAsset[] = [
  ...
  {
    key: "scifi-enemy-legs-idle",
    url: enemyLegsIdleUrl,
    frameWidth: 48,
    frameHeight: 48,
  },
  {
    key: "scifi-enemy-legs-walk",
    url: enemyLegsWalkUrl,
    frameWidth: 48,
    frameHeight: 48,
  },
  {
    key: "scifi-enemy-legs-run",
    url: enemyLegsRunUrl,
    frameWidth: 48,
    frameHeight: 48,
  },
...
export const ensureScifiAnimations = (scene: Phaser.Scene): void => {
  ...
  createAnimation(scene, "scifi-enemy-legs-idle", "scifi-enemy-legs-idle", 1, 1);
  createAnimation(scene, "scifi-enemy-legs-walk", "scifi-enemy-legs-walk", 6, 9);
  createAnimation(scene, "scifi-enemy-legs-run", "scifi-enemy-legs-run", 6, 12);
