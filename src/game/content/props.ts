...
export const createProps = (): PropEntity[] => [
  prop("news-desk-left", "table_5", 238, 205, 176, 64, { scale: 2.25 }),
  prop("news-desk-center", "table_1", 626, 170, 198, 70, { frame: 1, scale: 2.55 }),
  prop("control-desk-bottom", "table_1", 1116, 648, 198, 70, { scale: 2.55 }),
  prop("server-computer-1", "computer", 1016, 112, 46, 38, { frame: 4, scale: 1.7 }),
  prop("server-computer-2", "computer", 1062, 112, 46, 38, { frame: 5, scale: 1.7 }),
  prop("server-computer-3", "computer", 1108, 112, 46, 38, { frame: 6, scale: 1.7 }),
  prop("display-floor", "display_1", 1012, 354, 94, 46, { frame: 1, scale: 1.8, rotation: -0.35 }),
  prop("fallen-tv-bottom", "tv", 596, 558, 84, 48, { frame: 1, scale: 1.75 }),
  prop("fallen-tv-left", "tv", 285, 318, 70, 44, { scale: 1.45, rotation: 0.95 }),
  prop("chair-left-a", "chair_1", 192, 142, 38, 36, { frame: 1, scale: 1.55, rotation: Math.PI }),
  prop("chair-left-b", "chair_1", 284, 142, 38, 36, { scale: 1.55, rotation: Math.PI }),
  prop("chair-center-a", "chair_1", 598, 104, 38, 36, { frame: 1, scale: 1.55, rotation: Math.PI }),
  prop("chair-center-b", "chair_1", 698, 104, 38, 36, { scale: 1.55, rotation: Math.PI }),
  prop("couch-right", "couch_1", 1086, 240, 104, 48, { frame: 2, scale: 1.75 }),
  prop("plant-left", "plants", 150, 520, 38, 38, { scale: 1.45 }),
  prop("plant-right", "plants", 1210, 198, 36, 36, { frame: 2, scale: 1.35 }),
  prop("barrel-right", "barrel", 1100, 405, 38, 38, { scale: 1.4 }),
  prop("box-big-right", "box_big", 1042, 470, 58, 58, { scale: 1.05, rotation: 0.2 }),
  prop("box-small-right", "box_small", 972, 474, 34, 34, { scale: 1.1, rotation: -0.25 }),
  prop("keyboard-bottom", "keyboard_mouse", 1120, 615, 32, 32, { scale: 1.2, collider: false }),
  prop("lab-device-bottom", "laboratory_device", 236, 668, 42, 42, { scale: 1.25 }),
  prop("lamp-top-left", "wall_lamp", 438, 74, 24, 14, { frame: 1, scale: 1.7, collider: false }),
  prop("lamp-top-right", "wall_lamp", 838, 74, 24, 14, { frame: 1, scale: 1.7, collider: false }),
];
