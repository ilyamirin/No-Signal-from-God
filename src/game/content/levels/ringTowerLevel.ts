...
export const createRingTowerLevel = (): LevelDefinition => {
  ...
  return {
    ...
    weapons,
    doors: [
      door("ring-lift-door-left", { x: 1544, y: 1210 }, 0, -Math.PI / 2, Math.PI / 2),
      door("ring-lift-door-right", { x: 1656, y: 1210 }, Math.PI, Math.PI / 2, Math.PI * 1.5),
      ...
      door("ring-control-lobby-left", { x: 1820, y: 790 }, 0, -Math.PI / 2, Math.PI / 2),
      door("ring-control-lobby-right", { x: 1932, y: 790 }, Math.PI, Math.PI / 2, Math.PI * 1.5),
      door("ring-tech-entry-upper", { x: 2440, y: 980 }, Math.PI / 2, 0, Math.PI),
      door("ring-tech-entry-lower", { x: 2440, y: 1092 }, -Math.PI / 2, -Math.PI, 0),
      door("ring-backstage-entry-upper", { x: 2440, y: 1550 }, Math.PI / 2, 0, Math.PI),
      door("ring-backstage-entry-lower", { x: 2440, y: 1662 }, -Math.PI / 2, -Math.PI, 0),
    ...
    props: [
      ...
      prop("ring-tech-server-a", "laboratory_device", 2600, 955, 62, 62, { scale: 1.85 }),
      prop("ring-tech-server-b", "laboratory_device", 2720, 955, 62, 62, { scale: 1.85 }),
      prop("ring-tech-box-a", "box_big", 2750, 1160, 58, 58, { scale: 1.05, rotation: 0.2 }),
      prop("ring-tech-trash", "trash_can_2", 2520, 1165, 36, 36, { scale: 1.4 }),

      prop("ring-backstage-box-a", "box_big", 2580, 1480, 58, 58, { scale: 1.05, rotation: 0.2 }),
      prop("ring-backstage-box-b", "box_small", 2720, 1695, 34, 34, { scale: 1.1, rotation: -0.25 }),
      prop("ring-backstage-fake-wall", "display_2", 2785, 1515, 94, 46, { scale: 1.8, rotation: Math.PI / 2 }),
      prop("ring-backstage-crt-prop", "tv", 2635, 1770, 84, 48, { scale: 1.6, rotation: -0.45 }),
      prop("ring-backstage-light", "lamps", 2520, 1700, 40, 40, { frame: 2, scale: 1.4, collider: false }),
    ...
    enemies: [
      ...
      enemy(
        ...
        ai("patrolling", "backstage", {
          route: [{ x: 2740, y: 1545 }, { x: 2560, y: 1740 }, { x: 2740, y: 1545 }],
          routeIndex: 1,
        }),
      ),
      enemy(
        ...
        undefined,
        ai("posted", "backstage", {
          post: post({ x: 2580, y: 1705 }, Math.PI),
          perception: { visionRange: 390, visionAngle: Math.PI * 0.72, hearingRange: 620 },
        }),
      ),
      enemy(
